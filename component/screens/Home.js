  ...
  return (
    <Block block>
      <Block middle>
        ...
        <TextView padding={10} color={color2} h6>
          {num}
        </TextView>
...
constructor(props){
  ...
  componentDidMount(){
    ...
    .then(res => this.setState({cases:res.data.cases,recovered:res.data.recovered,deaths:res.data.deaths}))
        ...
        <Block padding={10} style={{marginTop: 10}}>
          ...
          <Block
            ...
            <ItemDot
              ...
              color2={Colors.carot}
              num={this.state.cases}
              title={'Infected'}
            />
            <ItemDot
              color1={Colors.red_op}
              color2={Colors.red}
              num={this.state.deaths}
              title={'Deaths'}
            />
